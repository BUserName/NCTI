...
class Pretrained_ResNet50(nn.Module):
    def __init__(self, model_name):
        ...
        state_dict = torch.load(os.path.join('/home/data6/transferability/self_sup_models_new/', self.model_name + '.pth'))
...
if __name__ == "__main__":
    ...
    models_hub = ['byol', 'deepcluster-v2', 'infomin', 'insdis', 'moco-v1',
              'moco-v2', 'pcl-v1', 'pcl-v2', 'sela-v2', 'swav']
    # models_hub = ['simclr-v2']
